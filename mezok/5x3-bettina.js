   ...
   // kerdez2 = kerdez ("Hanyadik osztályos vagy?");
    ...
    var kezelAlmaValasz = function(valasz) {
      ...
      for (szamlalo = 0; szamlalo < valasz; szamlalo++) {
        kiiruj("Kaptál egy telefont de elvették tőled miért nem vigyázol rá jobban?")
      }
    }

    kiiruj("Üdv, jósolok,nem fog maradni a most kapott telefonaid közül egy sem.", udvozlesUtan);
  }
});
